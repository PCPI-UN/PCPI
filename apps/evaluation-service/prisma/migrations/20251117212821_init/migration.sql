...
-- CreateTable
CREATE TABLE "public"."criterions_courses" (
    "criterion_id" INTEGER NOT NULL,
    "course_id" INTEGER NOT NULL,

    CONSTRAINT "criterions_courses_pkey" PRIMARY KEY ("criterion_id","course_id")
);
...
-- AddForeignKey
ALTER TABLE "public"."criterions_courses" ADD CONSTRAINT "criterions_courses_criterion_id_fkey" FOREIGN KEY ("criterion_id") REFERENCES "public"."criterions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
