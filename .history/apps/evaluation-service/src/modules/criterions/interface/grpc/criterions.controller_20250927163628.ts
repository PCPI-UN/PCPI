...
} from '../../../../../../../libs/common/src/generated/criterions';
...
export class CriterionsController {
  ...
  async createCriterion(request: CreateCriterionRequest): Promise<CreateCriterionResponse> {
    try {
      ...
      // Log success message
      console.log(`✅ Criterion created successfully: ${newCriterion.name} (ID: ${newCriterion.id})`);
      ...
      throw error; // The use case already handles the error formatting
    }
  }
  ...
  async updateCriterion(request: UpdateCriterionRequest): Promise<UpdateCriterionResponse> {
    try {
      ...
      // Log success message
      console.log(`✅ Criterion updated successfully: ${updatedCriterion.name} (ID: ${updatedCriterion.id})`);
  ...
  async listCriterions(request: ListCriterionsRequest): Promise<ListCriterionsResponse> {
    try {
      ...
      // Log success message
      console.log(`✅ Criterions retrieved successfully: ${criterions.length} criterions found`);
  ...
  async deleteCriterion(request: DeleteCriterionRequest): Promise<DeleteCriterionResponse> {
    try {
      ...
      // Log success message
      console.log(`✅ Criterion deleted successfully (ID: ${request.id})`);
