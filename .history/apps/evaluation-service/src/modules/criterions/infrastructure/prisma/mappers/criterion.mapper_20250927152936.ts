import { Criterion as PrismaCriterion, CriterionCourse as PrismaCriterionCourse } from '@prisma/client';
...
export class CriterionMapper {
  static toDomain(prismaCriterion: Prisma.CriterionGetPayload<{}>): Criterion {
  ...
  static criterionCourseToDomain(prismaCriterionCourse: Prisma.CriterionCourseGetPayload<{}>): CriterionCourse {
